...
metadata2$group <- NA
metadata2$group[which(str_detect(metadata2$orig.ident, "^Male_C"))] <- "Male_C"
metadata2$group[which(str_detect(metadata2$orig.ident, "^Male_M"))] <- "Male_M"
metadata2$group[which(str_detect(metadata2$orig.ident, "^Female_C"))] <- "Female_C"
metadata2$group[which(str_detect(metadata2$orig.ident, "^Female_M"))] <- "Female_M"
...
metadata2$case <- NA
metadata2$case[which(str_detect(metadata2$orig.ident, "^Male_C"))] <- "Control"
metadata2$case[which(str_detect(metadata2$orig.ident, "^Male_M"))] <- "MDD"
metadata2$case[which(str_detect(metadata2$orig.ident, "^Female_C"))] <- "Control"
metadata2$case[which(str_detect(metadata2$orig.ident, "^Female_M"))] <- "MDD"
metadata2$case[which(str_detect(metadata2$orig.ident, "^dlPFC_C"))] <- "Control"
metadata2$case[which(str_detect(metadata2$orig.ident, "^dlPFC_M"))] <- "MDD"
alldata_after1@meta.data <- metadata2

metadata2$batch <- NA
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C12"))] <- "MB1"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M9"))] <- "MB1"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C11"))] <- "MB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M2"))] <- "MB2"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C2"))] <- "MB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C5"))] <- "MB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C6"))] <- "MB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C14_1"))] <- "MB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M4"))] <- "MB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M6"))] <- "MB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M8"))] <- "MB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M16"))] <- "MB3"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C4"))] <- "MB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C7"))] <- "MB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C10"))] <- "MB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C13_2"))] <- "MB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M5"))] <- "MB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M7"))] <- "MB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M14"))] <- "MB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M15"))] <- "MB4"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C3"))] <- "MB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C14_2"))] <- "MB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C15"))] <- "MB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C17"))] <- "MB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M1"))] <- "MB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M10"))] <- "MB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M12"))] <- "MB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M13"))] <- "MB5"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C1"))] <- "MB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C8"))] <- "MB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C9"))] <- "MB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C13_1"))] <- "MB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_C16"))] <- "MB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M3"))] <- "MB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M11"))] <- "MB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Male_M17"))] <- "MB6"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C6"))] <- "FB1"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M8"))] <- "FB1"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M15"))] <- "FB1"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C7"))] <- "FB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C8"))] <- "FB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C9"))] <- "FB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C12"))] <- "FB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M16"))] <- "FB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M17"))] <- "FB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M19"))] <- "FB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M20"))] <- "FB2"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C2"))] <- "FB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C11"))] <- "FB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C13"))] <- "FB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M3"))] <- "FB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M4"))] <- "FB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M5"))] <- "FB3"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C1"))] <- "FB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C3"))] <- "FB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C4"))] <- "FB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C5"))] <- "FB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M2"))] <- "FB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M12"))] <- "FB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M13"))] <- "FB4"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M14"))] <- "FB4"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C14"))] <- "FB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C15"))] <- "FB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C16"))] <- "FB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C17"))] <- "FB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M1"))] <- "FB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M6"))] <- "FB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M7"))] <- "FB5"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M9"))] <- "FB5"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C10"))] <- "FB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_C18"))] <- "FB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M10"))] <- "FB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M11"))] <- "FB6"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^Female_M18"))] <- "FB6"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_M2"))] <- "MyB1"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_M3"))] <- "MyB1"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_M4"))] <- "MyB1"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_M5"))] <- "MyB1"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_M6"))] <- "MyB1"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_C2"))] <- "MyB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_C3"))] <- "MyB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_C4"))] <- "MyB2"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_C5"))] <- "MyB2"

metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_C1"))] <- "MyB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_C6"))] <- "MyB3"
metadata2$batch[which(str_detect(metadata2$orig.ident, "^dlPFC_M1"))] <- "MyB3"
alldata_after1@meta.data <- metadata2

metadata2$chemistry <- NA
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Male_C"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Male_M"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^dlPFC_C"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^dlPFC_M"))] <- "v3"

metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C1"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C2"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C3"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C4"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C5"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C10"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C11"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C13"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C14"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C15"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C16"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C17"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C18"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M1"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M2"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M3"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M4"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M5"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M6"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M7"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M9"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M10"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M11"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M12"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M13"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M14"))] <- "v3"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M18"))] <- "v3"

metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C6"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C7"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C8"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C9"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_C12"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M8"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M15"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M16"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M17"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M19"))] <- "v2"
metadata2$chemistry[which(str_detect(metadata2$orig.ident, "^Female_M20"))] <- "v2"
alldata_after1@meta.data <- metadata2

metadata2$dataset <- NA
metadata2$dataset[which(str_detect(metadata2$orig.ident, "^Male_C"))] <- "Male"
metadata2$dataset[which(str_detect(metadata2$orig.ident, "^Male_M"))] <- "Male"
metadata2$dataset[which(str_detect(metadata2$orig.ident, "^Female_C"))] <- "Female"
metadata2$dataset[which(str_detect(metadata2$orig.ident, "^Female_M"))] <- "Female"
metadata2$dataset[which(str_detect(metadata2$orig.ident, "^dlPFC_C"))] <- "My"
metadata2$dataset[which(str_detect(metadata2$orig.ident, "^dlPFC_M"))] <- "My"
alldata_after1@meta.data <- metadata2
...
metadata3$group <- NA
metadata3$group[which(str_detect(metadata3$orig.ident, "^Male_C"))] <- "Male_C"
metadata3$group[which(str_detect(metadata3$orig.ident, "^Male_M"))] <- "Male_M"
metadata3$group[which(str_detect(metadata3$orig.ident, "^Female_C"))] <- "Female_C"
metadata3$group[which(str_detect(metadata3$orig.ident, "^Female_M"))] <- "Female_M"
...
metadata3$case <- NA
metadata3$case[which(str_detect(metadata3$orig.ident, "^Male_C"))] <- "Control"
metadata3$case[which(str_detect(metadata3$orig.ident, "^Male_M"))] <- "MDD"
metadata3$case[which(str_detect(metadata3$orig.ident, "^Female_C"))] <- "Control"
metadata3$case[which(str_detect(metadata3$orig.ident, "^Female_M"))] <- "MDD"
metadata3$case[which(str_detect(metadata3$orig.ident, "^dlPFC_C"))] <- "Control"
metadata3$case[which(str_detect(metadata3$orig.ident, "^dlPFC_M"))] <- "MDD"
alldata_after@meta.data <- metadata3

metadata3$batch <- NA
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C12"))] <- "MB1"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M9"))] <- "MB1"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C11"))] <- "MB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M2"))] <- "MB2"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C2"))] <- "MB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C5"))] <- "MB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C6"))] <- "MB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C14_1"))] <- "MB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M4"))] <- "MB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M6"))] <- "MB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M8"))] <- "MB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M16"))] <- "MB3"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C4"))] <- "MB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C7"))] <- "MB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C10"))] <- "MB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C13_2"))] <- "MB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M5"))] <- "MB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M7"))] <- "MB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M14"))] <- "MB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M15"))] <- "MB4"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C3"))] <- "MB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C14_2"))] <- "MB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C15"))] <- "MB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C17"))] <- "MB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M1"))] <- "MB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M10"))] <- "MB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M12"))] <- "MB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M13"))] <- "MB5"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C1"))] <- "MB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C8"))] <- "MB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C9"))] <- "MB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C13_1"))] <- "MB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_C16"))] <- "MB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M3"))] <- "MB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M11"))] <- "MB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Male_M17"))] <- "MB6"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C6"))] <- "FB1"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M8"))] <- "FB1"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M15"))] <- "FB1"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C7"))] <- "FB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C8"))] <- "FB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C9"))] <- "FB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C12"))] <- "FB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M16"))] <- "FB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M17"))] <- "FB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M19"))] <- "FB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M20"))] <- "FB2"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C2"))] <- "FB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C11"))] <- "FB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C13"))] <- "FB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M3"))] <- "FB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M4"))] <- "FB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M5"))] <- "FB3"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C1"))] <- "FB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C3"))] <- "FB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C4"))] <- "FB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C5"))] <- "FB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M2"))] <- "FB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M12"))] <- "FB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M13"))] <- "FB4"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M14"))] <- "FB4"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C14"))] <- "FB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C15"))] <- "FB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C16"))] <- "FB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C17"))] <- "FB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M1"))] <- "FB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M6"))] <- "FB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M7"))] <- "FB5"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M9"))] <- "FB5"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C10"))] <- "FB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_C18"))] <- "FB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M10"))] <- "FB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M11"))] <- "FB6"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^Female_M18"))] <- "FB6"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_M2"))] <- "MyB1"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_M3"))] <- "MyB1"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_M4"))] <- "MyB1"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_M5"))] <- "MyB1"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_M6"))] <- "MyB1"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_C2"))] <- "MyB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_C3"))] <- "MyB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_C4"))] <- "MyB2"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_C5"))] <- "MyB2"

metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_C1"))] <- "MyB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_C6"))] <- "MyB3"
metadata3$batch[which(str_detect(metadata3$orig.ident, "^dlPFC_M1"))] <- "MyB3"
alldata_after@meta.data <- metadata3

metadata3$chemistry <- NA
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Male_C"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Male_M"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^dlPFC_C"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^dlPFC_M"))] <- "v3"

metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C1"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C2"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C3"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C4"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C5"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C10"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C11"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C13"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C14"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C15"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C16"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C17"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C18"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M1"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M2"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M3"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M4"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M5"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M6"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M7"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M9"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M10"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M11"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M12"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M13"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M14"))] <- "v3"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M18"))] <- "v3"

metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C6"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C7"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C8"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C9"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_C12"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M8"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M15"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M16"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M17"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M19"))] <- "v2"
metadata3$chemistry[which(str_detect(metadata3$orig.ident, "^Female_M20"))] <- "v2"
alldata_after@meta.data <- metadata3

metadata3$dataset <- NA
metadata3$dataset[which(str_detect(metadata3$orig.ident, "^Male_C"))] <- "Male"
metadata3$dataset[which(str_detect(metadata3$orig.ident, "^Male_M"))] <- "Male"
metadata3$dataset[which(str_detect(metadata3$orig.ident, "^Female_C"))] <- "Female"
metadata3$dataset[which(str_detect(metadata3$orig.ident, "^Female_M"))] <- "Female"
metadata3$dataset[which(str_detect(metadata3$orig.ident, "^dlPFC_C"))] <- "My"
metadata3$dataset[which(str_detect(metadata3$orig.ident, "^dlPFC_M"))] <- "My"
alldata_after@meta.data <- metadata3
...
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_C1"))] <- "dlPFC_C1"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_C2"))] <- "dlPFC_C2"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_C3"))] <- "dlPFC_C3"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_C4"))] <- "dlPFC_C4"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_C5"))] <- "dlPFC_C5"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_C6"))] <- "dlPFC_C6"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_M1"))] <- "dlPFC_M1"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_M2"))] <- "dlPFC_M2"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_M3"))] <- "dlPFC_M3"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_M4"))] <- "dlPFC_M4"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_M5"))] <- "dlPFC_M5"
metadata$sample[which(str_detect(metadata$orig.ident, "^dlPFC_M6"))] <- "dlPFC_M6"
Integ.obj@meta.data <- metadata

metadata$group <- NA
metadata$group[which(str_detect(metadata$orig.ident, "^Male_C"))] <- "Male_C"
metadata$group[which(str_detect(metadata$orig.ident, "^Male_M"))] <- "Male_M"
metadata$group[which(str_detect(metadata$orig.ident, "^Female_C"))] <- "Female_C"
metadata$group[which(str_detect(metadata$orig.ident, "^Female_M"))] <- "Female_M"
metadata$group[which(str_detect(metadata$orig.ident, "^dlPFC_C"))] <- "dlPFC_C"
metadata$group[which(str_detect(metadata$orig.ident, "^dlPFC_M"))] <- "dlPFC_M"
Integ.obj@meta.data <- metadata

metadata$case <- NA
metadata$case[which(str_detect(metadata$orig.ident, "^Male_C"))] <- "Control"
metadata$case[which(str_detect(metadata$orig.ident, "^Male_M"))] <- "MDD"
metadata$case[which(str_detect(metadata$orig.ident, "^Female_C"))] <- "Control"
metadata$case[which(str_detect(metadata$orig.ident, "^Female_M"))] <- "MDD"
metadata$case[which(str_detect(metadata$orig.ident, "^dlPFC_C"))] <- "Control"
metadata$case[which(str_detect(metadata$orig.ident, "^dlPFC_M"))] <- "MDD"
Integ.obj@meta.data <- metadata

metadata$batch <- NA
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C12"))] <- "MB1"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M9"))] <- "MB1"

metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C11"))] <- "MB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M2"))] <- "MB2"

metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C2"))] <- "MB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C5"))] <- "MB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C6"))] <- "MB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C14_1"))] <- "MB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M4"))] <- "MB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M6"))] <- "MB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M8"))] <- "MB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M16"))] <- "MB3"

metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C4"))] <- "MB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C7"))] <- "MB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C10"))] <- "MB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C13_2"))] <- "MB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M5"))] <- "MB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M7"))] <- "MB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M14"))] <- "MB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M15"))] <- "MB4"

metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C3"))] <- "MB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C14_2"))] <- "MB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C15"))] <- "MB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C17"))] <- "MB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M1"))] <- "MB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M10"))] <- "MB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M12"))] <- "MB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M13"))] <- "MB5"

metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C1"))] <- "MB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C8"))] <- "MB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C9"))] <- "MB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C13_1"))] <- "MB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_C16"))] <- "MB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M3"))] <- "MB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M11"))] <- "MB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Male_M17"))] <- "MB6"

metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C6"))] <- "FB1"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M8"))] <- "FB1"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M15"))] <- "FB1"

metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C7"))] <- "FB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C8"))] <- "FB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C9"))] <- "FB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C12"))] <- "FB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M16"))] <- "FB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M17"))] <- "FB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M19"))] <- "FB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M20"))] <- "FB2"

metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C2"))] <- "FB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C11"))] <- "FB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C13"))] <- "FB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M3"))] <- "FB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M4"))] <- "FB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M5"))] <- "FB3"

metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C1"))] <- "FB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C3"))] <- "FB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C4"))] <- "FB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C5"))] <- "FB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M2"))] <- "FB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M12"))] <- "FB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M13"))] <- "FB4"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M14"))] <- "FB4"

metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C14"))] <- "FB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C15"))] <- "FB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C16"))] <- "FB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C17"))] <- "FB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M1"))] <- "FB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M6"))] <- "FB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M7"))] <- "FB5"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M9"))] <- "FB5"

metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C10"))] <- "FB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_C18"))] <- "FB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M10"))] <- "FB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M11"))] <- "FB6"
metadata$batch[which(str_detect(metadata$orig.ident, "^Female_M18"))] <- "FB6"

metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_M2"))] <- "MyB1"
metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_M3"))] <- "MyB1"
metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_M4"))] <- "MyB1"
metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_M5"))] <- "MyB1"
metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_M6"))] <- "MyB1"

metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_C2"))] <- "MyB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_C3"))] <- "MyB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_C4"))] <- "MyB2"
metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_C5"))] <- "MyB2"

metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_C1"))] <- "MyB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_C6"))] <- "MyB3"
metadata$batch[which(str_detect(metadata$orig.ident, "^dlPFC_M1"))] <- "MyB3"
Integ.obj@meta.data <- metadata

metadata$chemistry <- NA
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Male_C"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Male_M"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^dlPFC_C"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^dlPFC_M"))] <- "v3"

metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C1"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C2"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C3"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C4"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C5"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C10"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C11"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C13"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C14"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C15"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C16"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C17"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C18"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M1"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M2"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M3"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M4"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M5"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M6"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M7"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M9"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M10"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M11"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M12"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M13"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M14"))] <- "v3"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M18"))] <- "v3"

metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C6"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C7"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C8"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C9"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_C12"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M8"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M15"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M16"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M17"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M19"))] <- "v2"
metadata$chemistry[which(str_detect(metadata$orig.ident, "^Female_M20"))] <- "v2"
Integ.obj@meta.data <- metadata

metadata$dataset <- NA
metadata$dataset[which(str_detect(metadata$orig.ident, "^Male_C"))] <- "Male"
metadata$dataset[which(str_detect(metadata$orig.ident, "^Male_M"))] <- "Male"
metadata$dataset[which(str_detect(metadata$orig.ident, "^Female_C"))] <- "Female"
metadata$dataset[which(str_detect(metadata$orig.ident, "^Female_M"))] <- "Female"
metadata$dataset[which(str_detect(metadata$orig.ident, "^dlPFC_C"))] <- "My"
metadata$dataset[which(str_detect(metadata$orig.ident, "^dlPFC_M"))] <- "My"
Integ.obj@meta.data <- metadata
...
pdf("DotPlot_All.pdf", width = 13, height = 9)
DotPlot(Integ.obj,features = AllMarkers, cols=c("#e8e8e8", "#751665")) +  ##0b488a #a10d63 #751665 #0a4d54
...
DotPlot(Integ.obj,features = c("NRGN", "THY1", "BEX1"), cols=c("#e8e8e8", "#751665")) +  ##0b488a #a10d63 #751665 #0a4d54
  theme(axis.text.x = element_text(angle = 90, size=11),
...
NonNeuron <- c("SLC1A2", "GFAP",
               ...
               "CX3CR1", "CD44",
               "CLDN5")
Astro <- c("SLC1A2", "GLUL", "SOX9", "AQP4", "GJA1", "NDRG2", "ALDH1A1", "ALDH1L1", "GFAP")
...
my_cols = c("#232422", "#232422", "#232422", "#232422", #Neuron
            "#6c43bf", "#6c43bf", "#6c43bf", #ExN
            "#e897c7", "#e897c7", "#e897c7", #InN
            "#d9252f", "#d9252f", "#d9252f", #Astro
            "#FFB500", "#FFB500",            #OPC
            "#967341", "#967341", "#967341", #Oligo
            "#3aa312", "#3aa312",
            "#3aa312", "#3aa312", "#3aa312", #Micro
            "#2e75d1", "#2e75d1")            #Endo

FeaturePlot(object=Integ.obj, reduction="umap.harmony", features=Oligo, label=F, min.cutoff = "q9", ncol=3)
VlnPlot(object=Integ.obj, features=Neuron, pt.size=0, stack = T, flip = T) + NoLegend()

tiff(filename = "DotPlot_All5.tif", width = 11, height = 9, units = "in", res=300)
DotPlot(Integ.obj,features = AllMarkers, cols=c("#e8e8e8", "#751665")) +  ##0b488a #a10d63 #751665 #0a4d54
  theme(axis.text.x = element_text(angle = 90, size=11),
        axis.text.x.bottom = element_text(colour = my_cols, face=3),
        legend.title=element_text(size=10))+
...
DefaultAssay(Integ.obj) <- "RNA"
tiff(filename = "E:/Human_Single_cell/Full_data_final_v2_dlPFC/NoDecontX/2. 400&9000/DotPlot_All6.tif", width = 13, height = 9, units = "in", res=300)
DotPlot(Integ.obj,features = AllMarkers, cols=c("#e8e8e8", "#751665")) +  ##0b488a #a10d63 #751665 #0a4d54
  theme(axis.text.x = element_text(angle = 90, size=11),
        axis.text.x.bottom = element_text(colour = my_cols, face=3),
        legend.title=element_text(size=10))+
...
tiff(filename = "E:/Human_Single_cell/Full_data_final_v2_dlPFC/NoDecontX/2. 400&9000/VlnPlot_All2.tif", width = 13, height = 9, units = "in", res=300)
VlnPlot(Integ.obj, features=AllMarkers, stack=T, sort=F, flip=F) +
...
VlnPlot(Integ.obj, group.by = "Newcluster", features = "percent.mt", pt.size = 0) +
  NoLegend() &
  geom_boxplot(width = 0.15, notch = FALSE, outlier.shape = NA, coef=0) &
  theme(strip.text.x = element_text(size=10),
        axis.text.y = element_text(size=10))&
  labs(x=NULL, y="Mito %")

DimPlot(Integ.obj, reduction = "umap.harmony", label = TRUE, label.size=3, repel=F, raster=T) + NoLegend()
DimPlot(Integ.obj, reduction="tsne", label=T, cols=my_cols2, label.size=3, repel=F, raster=T) + NoLegend()
...
p1 <- DimPlot(Integ.obj, reduction = "umap.harmony", group.by = "group")
p2 <- DimPlot(Integ.obj, reduction="umap.harmony", group.by="sample")
p1 + p2
DimPlot(object=Integ.obj, reduction="umap.harmony", group.by="region")
DimPlot(object=Integ.obj, reduction="umap.harmony", split.by="group", ncol=2, cols=my_cols2)
DimPlot(object=Integ.obj, reduction="umap.harmony", split.by="region", ncol=2, label=T, cols=my_cols2)
DimPlot(object=Integ.obj, reduction="umap.harmony", split.by="state", ncol=2, cols=my_cols2)
