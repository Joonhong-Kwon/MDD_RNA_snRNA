...
pdf("QC/Before_QC_nodot.pdf", width = 11, height = 6)
...
combined.list$dlPFC_M6 <- doubletFinder_v3(combined.list$dlPFC_M6, pN = 0.25, pK = 0.08, nExp = nExp,                                         PCs = 1:10, reuse.pANN=F)
...
feats <- c("nFeature_RNA", "nCount_RNA", "percent.mt", "percent.ribo", "percent.hemo")
pdf("QC/After_QCDF_nodot.pdf", width = 11, height = 6)
...
full.combined <- readRDS(file="Seurat.Clustering_PC44_res0.8.RDS")
