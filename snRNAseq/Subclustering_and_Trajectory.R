...
DimPlot(object=Oligo.sub, reduction="umap", split.by="group", ncol=2)
...
list_cluster <- Oligo.sub@active.ident
cds@clusters$UMAP$clusters <- list_cluster

# Assign UMAP coordinate - cell embeddings
cds@int_colData@listData$reducedDims$UMAP <- Oligo.sub@reductions$umap@cell.embeddings
