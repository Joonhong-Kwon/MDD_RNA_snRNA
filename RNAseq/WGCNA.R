...
# Plot the dendrogram and the module colors underneath
tiff(filename = "Cluster Dendrogram_v1.tif", width = 5, height = 3, units = "in", res=500)
plotDendroAndColors(net$dendrograms[[1]], mergedColors[net$blockGenes[[1]]],
                    "Module colors",
                    dendroLabels = FALSE, hang = 0.03,
                    addGuide = TRUE, guideHang = 0.05)
...
tiff(filename = "Module-trait relationship_1.tif", width = 8, height = 12, units = "in", res=300)
...
#kME-----------------------------------------------------------------
#before do this, shut down (don't save workspace) and restart
...
modules = "greenyellmodules" = "orangered4"
...
Cell = read.csv(paste("Cell type Ensembl/Cell type_H_M",num,".csv", sep=""))
